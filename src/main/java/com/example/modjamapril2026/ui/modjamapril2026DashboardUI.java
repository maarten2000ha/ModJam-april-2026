package com.example.modjamapril2026.ui;
...
/**
 * mod jam april 2026 Dashboard UI
 *
 * A simple interactive dashboard page showing plugin information
 * with refresh and close buttons.
 */
public class modjamapril2026DashboardUI extends InteractiveCustomUIPage<modjamapril2026DashboardUI.UIEventData> {

    // Path relative to Common/UI/Custom/
    public static final String LAYOUT = "modjamapril2026/Dashboard.ui";

    private final PlayerRef playerRef;
    private int refreshCount = 0;

    public modjamapril2026DashboardUI(@Nonnull PlayerRef playerRef) {
        ...
        switch (data.action) {
            case "refresh":
                ...
                NotificationUtil.sendNotification(
                    ...
                    Message.raw("mod jam april 2026"),
